...
public class BinarySearchTree {
	...
	private int getLevelFor(Node r, int level, int value) {
		if (r == null)
			throw new RuntimeException("ERRO: nodo n�o encontrado!");
	...
	private void getPathTo(Node r, ArrayList<Integer> result, int value) {
		if (r == null)
			throw new RuntimeException("ERRO: valor n�o encontrado!");
	...
	/**
	 * Retorna {@code true} se a �rvore n�o cont�m nodos.
	 * 
	 * @return {@code true} se a �rvore n�o cont�m nodos
	 */
	...
	/**
	 * Retorna uma lista com os valores pares armazenados na �rvore.
	 * 
	 * @return
	 */
	...
	/**
	 * Visita cada nodo da �rvore e executa o m�todo process do Processor sobre
	...
	public List<Integer> getPath(int elem1, int elem2) {
		List<Integer> result = new ArrayList<>();
		
		List<Integer> path1 = getPathToRoot(elem1);
		List<Integer> path2 = getPathToRoot(elem2);
		
		int c = 0;
		for (int i = 0; i < path1.size(); i++) {
			if (path1.get(i) == path2.get(0)) { 
				path2.remove(0);
				c++;
			}
		}
