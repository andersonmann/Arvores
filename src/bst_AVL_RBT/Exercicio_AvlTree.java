...
//public class Exercicio_AvlTree {
...
//Comparable findMinovo  --> Return smallest item
//Comparable findMaxovo  --> Return largest item
//boolean isEmptyovo     --> Return true if empty; else false
//void makeEmptyovo      --> Remove all items
//void printTreeovo      --> Print tree in sorted order
//******************ERRORS********************************
 ...
 */
public class Exercicio_AvlTree<AnyType extends Comparable<? super AnyType>> {
	/**
	 * Construct the tree.
	 */
	public Exercicio_AvlTree() {
		root = null;
	}
	...
	public String desenhaArvoreA1() {
		return desenhaArvoreA1(root, 0);
	}

	private String desenhaArvoreA1(AvlNode<AnyType> n, int ac) {
		if (n != null) {
			return String.format("%s%s\n%s%s", pad(ac), n.element,
					desenhaArvoreA1(n.right, ac + 1),
					desenhaArvoreA1(n.left, ac + 1));
		}
		return "";
	}
